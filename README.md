...
- **Next:** story-state bank refinement (light/dark variants share a group but use different banks via game progression — exact selection lands with **M4**), `<chaN>` real party-name substitution, range-trigger extents, common-event (boot 4/5) + auto (boot 0) events.
