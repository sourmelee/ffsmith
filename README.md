...
- **Next:** **M5** menu system (real Item/Equip/Status pages from the toolkit's decoded tables) and **M6** battle; plus field polish (story-state dialogue banks, `<chaN>` party names, range triggers, common/auto events).
