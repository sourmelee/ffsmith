...
- **Next:** **header-encoded door/stairs warps** — most doors don't use the script `MapChange`; their destination is encoded in the event record itself (still to be decoded). Then a font/text pass for real dialogue.
