...
- **Next:** **cross-map warps** — door/stairs destinations are *header-encoded* in the event record (not the rare script `MapChange` 0x41), so they need a dedicated decode; then a font/text pass for real dialogue.
